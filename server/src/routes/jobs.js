...
function getMockJobs(query = 'developer', location = '', platform = 'all') {
    ...
    const jobs = [
        ...
        { id: 'm3', title: `Project Manager`, company: 'Wipro', location: loc, isRemote: false, description: `We are seeking an experienced Project Manager to oversee software development projects from concept to delivery. This role requires strong leadership skills to manage cross-functional teams, coordinate timelines, manage budgets, and ensure quality delivery. You should have experience with Agile/Scrum methodologies, excellent communication skills, and the ability to manage stakeholder expectations. Responsibilities include sprint planning, risk management, team motivation, and ensuring projects are delivered on time and within scope. The ideal candidate has 5+ years of project management experience in software development, certifications like PMP or Scrum Master are preferred. You'll work on diverse projects serving clients across various industries. This is a great opportunity to grow your management skills and develop your leadership capabilities.`, salary: 'INR 15,00,000 – 25,00,000/yr', jobType: 'Full-time', postedDate: new Date(Date.now() - 259200000).toISOString(), url: `https://www.naukri.com/manager-jobs-in-${loc.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`, source: 'Resumate Jobs', skills: ['Agile', 'Scrum', 'Management'], highlights: [], experience: '5 yrs' },
        { id: 'm4', title: `Python ${q}`, company: 'Wipro', location: loc, isRemote: false, description: `We're looking for a Python Developer to build and maintain data engineering solutions and backend services for our platform. You'll work with Python, Django, and PostgreSQL to develop scalable, high-performance systems. Responsibilities include writing clean, documented code, optimizing database queries, building APIs, and deploying to production environments. You should have 2+ years of Python experience, familiarity with SQL databases, and understanding of software development best practices. We value developers with problem-solving abilities, attention to detail, and a collaborative mindset. This position offers exposure to big data technologies, machine learning pipelines, and modern cloud infrastructure. Great team environment with code reviews, knowledge sharing, and professional growth opportunities. Experience with REST APIs, Git, and Linux is expected.`, salary: 'INR 6,00,000 – 12,00,000/yr', jobType: 'Full-time', postedDate: new Date(Date.now() - 345600000).toISOString(), url: `https://www.naukri.com/python-jobs-in-${loc.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`, source: 'Resumate Jobs', skills: ['Python', 'Django', 'PostgreSQL'], highlights: [], experience: '2 yrs' },
        { id: 'm5', title: `QA Engineer`, company: 'Infosys', location: loc, isRemote: true, description: `Join our Quality Assurance team and ensure the quality of our software products across web and mobile platforms. As a QA Engineer, you'll design and execute test cases, create automated tests using Selenium, perform regression testing, and collaborate with developers to identify and resolve bugs. You should have 1-3 years of QA experience, strong understanding of testing methodologies, and proficiency in Test Automation frameworks. Responsibilities include manual testing, writing test scripts, identifying edge cases, and providing detailed bug reports. The ideal candidate has excellent attention to detail, strong communication abilities, and the ability to work in a remote environment independently. Knowledge of Jest, CI/CD pipelines, and API testing is beneficial. We offer flexible working hours, a supportive team, and opportunities to learn new technologies while working on products used by millions.`, salary: 'INR 5,00,000 – 9,00,000/yr', jobType: 'Full-time', postedDate: new Date(Date.now() - 432000000).toISOString(), url: `https://www.naukri.com/qa-jobs-in-${loc.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`, source: 'Resumate Jobs', skills: ['Selenium', 'Jest', 'Automation'], highlights: [], experience: '1-3 yrs' },
        { id: 'm6', title: `Junior ${q}`, company: 'HCLTech', location: loc, isRemote: false, description: `Perfect opportunity for recent graduates to start your software development career. We're looking for enthusiastic Junior Developers to join our team and grow your skills in a supportive environment. You'll work on building web applications using modern technologies including JavaScript, HTML, and CSS. This entry-level position offers mentorship from senior developers, exposure to real-world projects, and opportunities to learn best practices in software development. Responsibilities include writing clean code, participating in code reviews, assisting in debugging and testing, and contributing to project documentation. We value curiosity, willingness to learn, problem-solving ability, and teamwork. You should have foundational knowledge of web development, basic understanding of programming concepts, and excitement to start your tech career. We provide comprehensive training, collaborative work environment, and career growth opportunities. Knowledge of version control (Git) and basic database concepts are beneficial.`, salary: 'INR 4,00,000 – 7,00,000/yr', jobType: 'Full-time', postedDate: new Date(Date.now() - 518400000).toISOString(), url: `https://www.naukri.com/junior-jobs-in-${loc.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`, source: 'Resumate Jobs', skills: ['JavaScript', 'HTML', 'CSS'], highlights: [], experience: '0-1 yrs' },
